...
/*   Updated: 2023/09/11 20:12:45 by itan             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color_c	phong_reflection(t_minirt *minirt, t_hit_info hit_info)
{
	...
	// amb = color_multiply(minirt->amb_light.color, hit_info.material.color);
	amb = color_scale(minirt->amb_light.color, minirt->amb_light.ratio);
	...
	specular = color_tween(hit_info.material.color,
							hit_info.material.specular,
							dot_prod);
